                ...
                <main>
                    <div class="px-4 pt-6">
                        <div class="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3">
                            <!-- Main widget -->
                            <div
                                class="p-4 bg-white border border-gray-200 rounded-lg shadow-lg 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                            ...
                            <!--Tabs widget -->
                            <div
                                class="p-4 bg-white border border-gray-200 rounded-lg shadow-lg dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                                ...
                                <div data-popover id="popover-description" role="tooltip"
                                    class="absolute z-10 invisible inline-block text-sm font-light text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">
                                    ...
                                    <div class="hidden pt-4" id="faq" role="tabpanel" aria-labelledby="faq-tab">
                                        <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                                            ...
                                            <li class="py-3 sm:py-4">
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center min-w-0">
                                                        <img class="flex-shrink-0 w-10 h-10" src=""
                                                            alt="imac image">
                                                        <div class="ml-3">
                                                            <p class="font-medium text-gray-900 truncate dark:text-white">
                                                                Apple iMac 27"
                        ...
                        <div class="grid w-full grid-cols-1 gap-4 mt-4 xl:grid-cols-2 2xl:grid-cols-3">
                            <div
                                class="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-lg sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                                <div class="w-full">
                        ...
                        <div class="grid grid-cols-1 my-4 xl:grid-cols-2 xl:gap-4">
                            <div
                                class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-lg sm:p-6 dark:border-gray-700 dark:bg-gray-800 xl:mb-0">
                                <div class="flex items-center justify-between mb-4">
                                ...
                                <form class="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
                                    <article class="mb-5">
                                        ...
                                        <p class="mb-2 text-gray-900 dark:text-white">
                                            ...
                                            gather
                                            everyone
                                            involved in the design project. Let me know about your availability in the
                                            thread.
                                        </p>
                                    ...
                                    <article class="mb-5">
                                        ...
                                        <p class="mb-2 text-gray-900 dark:text-white">
                                            ...
                                            start
                                            working on
                                            this new project with you guys. But first things first, I'am waiting for the
                                            offer
                                            and
                                            pitch
                                    ...
                                    <article class="mb-5">
                                        ...
                                        <p class="mb-2 text-gray-900 dark:text-white">
                                            ...
                                            I'am
                                            attaching our offer and pitch deck. Take your time to review everything. I'am
                                            looking
                                            forward to
                        ...
                        <div class="grid grid-cols-1 my-4 xl:grid-cols-2 xl:gap-4">
                            <!-- Activity Card -->
                            <div
                                class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-lg dark:border-gray-700 sm:p-6 dark:bg-gray-800 xl:mb-0">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <div class="relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]">
                                        <div class="hidden duration-700 ease-in-out bg-white dark:bg-gray-800"
                                            ...
                                            <p class="mb-4 text-gray-500 dark:text-gray-400">Get started with a free and
                                                open-source
                                                admin
                                                dashboard layout built with Tailwind CSS and Flowbite featuring charts,
                                                widgets,
                                                CRUD
                                                layouts, authentication pages, and more</p>
                                            <p class="mb-2 text-lg font-medium text-gray-900 dark:text-white">Key Takeaways:
                                            </p>
                                        ...
                                        <div class="hidden duration-700 ease-in-out bg-white dark:bg-gray-800"
                                            ...
                                            <p class="mb-4 text-gray-500 dark:text-gray-400">Marketing, sales & business
                                                ...
                                                for
                                                small
                                                business. Improve your marketing & promotion results - and grow your sales!
                                            </p>
                                            ...
                                            <ul role="list"
                                                ...
                                                <li class="flex space-x-2">
                                                    ...
                                                    <span class="leading-tight">Learn from competitors about what to do, and
                                                        not
                                                        to
                                                        do</span>
                                                </li>
                                        ...
                                        <div class="hidden duration-700 ease-in-out bg-white dark:bg-gray-800"
                                            ...
                                            <p class="text-gray-500 dark:text-gray-400">Deliver great service experiences
                                                ...
                                                without
                                                the
                                                complexity of traditional ITSM solutions.Accelerate critical development
                                                work,
                                                eliminate
