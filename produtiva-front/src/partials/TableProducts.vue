<template>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" v-for="product in products"
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    ...
                                    <button type="button" id="deleteProductButton" @click="setProductId(product.id)"
    ...
    <div
        ...
        <div class="flex items-center space-x-3">
            <button @click="tableBind" id="prev"
            ...
            <button @click="tableBind" id="next"
                class="inline-flex items-center justify-center flex-1 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                Next
    ...
    <div id="drawer-delete-product-default"
        ...
        <a href="#" data-drawer-dismiss="drawer-delete-product-default" aria-controls="drawer-delete-product-default"
...
export default {
    ...
    methods: {
        async tableBind() {
            if (event) {
                pageInput = event.target.id == "prev" && next.value >= 1 ? --next.value : ++next.value;
            }
            try {
                const { data } = await http.get(`/product/list/limit/5/page/${pageInput}`);
        ...
        async deleteProduct() {
            try {
                const { data } = await http.post(`/product/destroy`, this.product_id);
